...
for i in range(num_epochs):
    for j in range(num_batches_t):
        tmp_data = np.load('C:/Users/alber/nequip/nequip/scripts/training_features/feats_t_epoch'
    ...
    for j in range(num_batches_v):
        tmp_data = np.load('C:/Users/alber/nequip/nequip/scripts/training_features/feats_v_epoch'
                           + str(i + 1) + '_batch' + str(j + 1) + '.npz')
        raw_data.append(tmp_data['arr_0'])
