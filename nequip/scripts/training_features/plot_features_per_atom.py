...
# avg_data_C1 = np.empty((1, 240))
# epoch1_v = np.load('C:/Users/alber/nequip/nequip/scripts/training_features/feats_v_epoch10.npz')
#
# for key in epoch1_v.files:
#     avg_data_C1 = np.concatenate((avg_data_C1, epoch1_v[key][0:105:21]))
#
# avg_data_C1 = avg_data_C1[1:]
# avg_data_C1 = np.average(avg_data_C1, axis=1)
# print(avg_data_C1)
