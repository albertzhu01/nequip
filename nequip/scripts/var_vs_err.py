...
for i in range(10):
    train_pred_forces.append(
        np.load(f"/n/home10/axzhu/nequip/ensembles_1200K/train_forces_ensemble{i}_200K.npz")['arr_0'])
...
plt.legend(fontsize=16)
plt.title(
    f"Mean Local Energy Variance vs. Total Energy Squared MAE (Train 300K, Test 1200K)",
    fontsize=24
)
plt.xlabel("Total Energy Squared MAE (eV²)", fontsize=18)
plt.ylabel("Mean Local Energy Variance ((eV/A)²)", fontsize=18)
plt.savefig(f"mean-loc-e-var_tot-err_1200K.png")
...
plt.legend(fontsize=16)
plt.title(
    f"Mean Local Energy Variance vs. Total Energy Variance (Train 300K, Test 1200K)",
    fontsize=24
)
plt.xlabel("Total Energy Variance (eV²)", fontsize=18)
plt.ylabel("Mean Local Energy Variance ((eV/A)²)", fontsize=18)
plt.savefig(f"mean-loc-e-var_tot-var_1200K.png")
